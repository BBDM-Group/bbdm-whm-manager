...
def Cookie(IP, user, token):
    # // Getting Cpanels Total Count
    global sectoken, STATUS, session, headers
    URL = 'https://{}:2087/json-api/create_user_session?api.version=1&user={}&service=whostmgrd'.format(IP, user)
    headers = {
    ...
    # // print src
    if 'security_token' in src:
        STATUS = 'good'
        sectoken = r.json()['data'].get('cp_security_token').replace('/','')
        # // print sectoken
    else:
        STATUS = 'bad'
    ...
    if STATUS == 'good':
        ...
        while 1:
            if TRIES != 10:
                ...
                REQ = session.post(create_url, data=cp_create_data, headers=headers, verify=False)
...
if __name__ == '__main__':
    ...
    print('{} -| {}1{} | {}Create New Cpanels{}.'.format(RED, WHITE, RED, WHITE, RED))
    time.sleep(0.1)
    print('{} -| {}2{} | {}Change All Cpanels Password [WHM]{}.'.format(RED, WHITE, RED, WHITE, RED))
    time.sleep(0.1)
    print('{} -| {}3{} | {}Change CPanels Password [CPS]{}.'.format(RED, WHITE, RED, WHITE, RED))
    time.sleep(0.1)

    print(' {}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---{}---\n'.format(RED, WHITE, RED, WHITE, RED, WHITE, RED, WHITE, RED, WHITE, RED,RED, WHITE, RED, WHITE, RED, WHITE, RED, WHITE))
    time.sleep(0.1)

    # ///////////////////////////////////////////////// ## ///////////////////////////////////////////////// #

    ask = input('\t{} -| {}Choose A Tool {}: '.format(WHITE, RED, WHITE))
    ...
    if ask == 1:
        # // Create Cpanel
        Host = input(' \t\t{}-| {}Enter Your Host         {}: '.format(RED, WHITE, RED))
        Login = input(' \t\t{}-| {}Enter Your Login          {}: '.format(RED, WHITE, RED))
        Token = input(' \t\t{}-| {}Enter Your Token     {}: '.format(RED, WHITE, RED))
        Email = input(' \t\t{}-| {}Enter Your Email        {}: '.format(RED, WHITE, RED))
        Package = input(' \t\t{}-| {}Enter Your Package      {}: '.format(RED, WHITE, RED))
        Domains_List = input(' \t\t{}-| {}Enter Your Domains List {}: '.format(RED, WHITE, RED))
        Cookie(Host, Login, Token)
        print('\n')
        ...
        Host = input(' \t\t{}-| {}Enter Your Host          {}: '.format(RED, WHITE, RED))
        Log = input(' \t\t{}-| {}Enter Your Log           {}: '.format(RED, WHITE, RED))
        Password = input(' \t\t{}-| {}Enter Your Password      {}: '.format(RED, WHITE, RED))
        PASS = input(' \t\t{}-| {}Enter Password To Change {}: '.format(RED, WHITE, RED))
        ...
        # // Changing All Passwords
        Cpanels = input(' \t\t{}-| {}Enter Your Cpanels File {}: '.format(RED, WHITE, RED))
        PASS = input(' \t\t{}-| {}Enter Password To Change {}: '.format(RED, WHITE, RED))
        try:
            fi = open(Cpanels, 'r')
            for i in fi:
